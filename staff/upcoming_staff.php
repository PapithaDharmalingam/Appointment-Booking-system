...
if(isset($_POST['save'])){
	...
	mysqli_query($conn,"update appointments set status='cancelled' WHERE appointment_no='".$update_id."'");
...
<p align="center"><button type="submit" class="btn btn-success" name="save"> cancel appointments</button></p>
</form>
<script>
